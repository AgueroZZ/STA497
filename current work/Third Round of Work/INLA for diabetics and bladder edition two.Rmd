...
\end{aligned}\end{equation}
where each $\tilde{\Delta}_i$ is defined as $(\Delta_{i,i+1},\Delta_{i,i+2},...,\Delta_{i,n})^T$.

Using this notation, we can write the the negated hessian matrix $C_i$ of the i-th observation's log-likelihood, with respect to $\tilde{\Delta}_i$ being:
\begin{equation}
C_i = \begin{pmatrix} 
