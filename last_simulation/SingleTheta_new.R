...
Q_matrix_iid <- function(theta,model_data,tau = exp(12)) {
...
Q_matrix_rw2 <- function(theta,model_data,tau = exp(12), buffer = 1/exp(12)) {
  # Figure out how many rw2 components there are
...
Q_matrix_both_rw2_linear <- function(theta,model_data,tau = exp(12) , buffer = 1/exp(12)) {
...
Q_matrix_both_rw2_iid <- function(theta,model_data,tau = exp(12),buffer = 1/exp(12)) {
...
Q_matrix_both_iid_linear <- function(theta,model_data,tau = exp(12)) {
...
Q_matrix_all <- function(theta,model_data,tau = exp(12)) {
...
log_posterior_theta_withbuffer <- function(theta,W,model_data,Q = NULL, buffer = 1/exp(12)) {
